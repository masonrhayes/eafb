...
The coefficients for number of brokers and for the percent of county residents with some college education are both significant at the 5% level. The effect of the number of brokers seems to be slightly dampened after adjusting for education levels in the county; it changes from $-2.73 \times 10^{-6}$ to $1.94 \times 10^{-6}$. For an increase of one percentage point in those with less than a high school diploma, there is an decrease of 0.11 percentage points of misconduct; in those counties with a higher fraction of residents who have lower than a high school education, there is a higher likelihood of financial misconduct.

This estimate is not robust to the inclusion of different educational measures; after controlling for _some college_, for example, the coefficient for `pct_less_than_hs` is no longer significant.
